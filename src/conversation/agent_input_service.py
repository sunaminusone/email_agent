...
def build_agent_input(
    ...
    return AgentContext(
        ...
        active_service_name=session_payload.active_service_name,
        active_product_name=session_payload.active_product_name,
        active_business_line=session_payload.active_business_line,
        active_target=session_payload.active_target,
